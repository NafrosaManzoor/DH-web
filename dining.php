    ...
    <div class="container">
        <div class="row" style="margin-top: 100px;">
            ...
            $products = [
                ...
                ["id" => 4, "name" => " Industrial", "image" => "./image/t3.jpg", "price" => 900.50, "description" => "Let's Choose"],
                ["id" => 4, "name" => "Butterfly Leaf", "image" => "./image/t5.jpg", "price" => 900.50, "description" => "Let's Choose"],
                ["id" => 4, "name" => "Traditional ", "image" => "./image/t6.jpg", "price" => 900.50, "description" => "Let's Choose"],
                ["id" => 4, "name" => "Farm House", "image" => "./image/t2.jpg", "price" => 900.50, "description" => "Let's Choose"],
                ["id" => 4, "name" => "Balance Dining", "image" => "./image/t4.jpg", "price" => 900.50, "description" => "Let's Choose"],
                ["id" => 4, "name" => "Shaker Dining", "image" => "./image/t1.jpg", "price" => 900.50, "description" => "Let's Choose"],
            ];
