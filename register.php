    ...
    <div id='login-form' class='login-page'>
        <div class="form-box">
            <form id='register' class='input-group-register' action="register.php" method="post">
                ...
                <input type='password' name="cpassword" class='input-field' placeholder='Confirm Password' required> <br><br>
...
if (isset($_POST['submit'])) {
    ...
    $c_password = password_hash($_POST["cpassword"], PASSWORD_DEFAULT);
    ...
    $query = "INSERT INTO logi (username, password) VALUES ('$name', '$password')";

    if (mysqli_query($conn, $query)) {
        // Insert data into the 'user_details' table
        $sql = "INSERT INTO regi ( email, confirm_password, password) 
                VALUES ('$email', '$c_password', '$password')";
