  ...
  <div class="container">
    <div class="row" style="margin-top: 100px;">
      ...
      $products = [
        ...
        ["id" => 4, "name" => "Lamber Sofa", "image" => "./image/s5.jpg", "price" => 900.50, "description" => "Let's Choose"],
        ["id" => 4, "name" => "Kendail Sofa", "image" => "./image/s4.jpg", "price" => 900.50, "description" => "Let's Choose"],
        ["id" => 4, "name" => "Ledger Lettel  ", "image" => "./image/s1.jpg", "price" => 900.50, "description" => "Let's Choose"],
        ["id" => 4, "name" => "Highlander Sofa", "image" => "./image/s2.jpg", "price" => 900.50, "description" => "Let's Choose"],
        ["id" => 4, "name" => "Halifax Sofa", "image" => "./image/s3.jpg", "price" => 900.50, "description" => "Let's Choose"],
