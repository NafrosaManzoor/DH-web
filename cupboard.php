...
<body>
    ...
    <div class="container">
        <div class="row" style="margin-top: 100px;">
            <?php
            $products = [
                ["id" => 1, "name" => "Side Board", "image" => "./image/w4.jpg", "price" => 300.20, "description" => "Let's Choose"],
                ["id" => 3, "name" => "Cupboard", "image" => "./image/w2.jpg", "price" => 900.50, "description" => "Let's Choose"],
                ["id" => 4, "name" => "Cabinet Carcass", "image" => "./image/w3.jpg", "price" => 900.50, "description" => "Let's Choose"],
                ["id" => 4, "name" => "Cabinet ", "image" => "./image/w8.jpg", "price" => 900.50, "description" => "Let's Choose"]
            ];
